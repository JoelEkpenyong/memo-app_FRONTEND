  ...
  return (
    <header>
      <nav id="side_nav" className="d-inline-flex flex-column">
        <div className="padded d-inline-flex flex-column">
          <div className="d-flex align-items-center justify-content-between w-100">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                <g fill="none"><path d="M12 12l7 7" stroke="#2D9CDB" strokeWidth="2" strokeLinecap="round" className="il-md-length-15 il-md-duration-4 il-md-delay-0"/>
                  <path d="M12 12L5 5" stroke="#2D9CDB" strokeWidth="2" strokeLinecap="round" className="il-md-length-15 il-md-duration-4 il-md-delay-0"/>
                  <path d="M12 12l-7 7" stroke="#2D9CDB" strokeWidth="2" strokeLinecap="round" className="il-md-length-15 il-md-duration-4 il-md-delay-0"/>
                  <path d="M12 12l7-7" stroke="#2D9CDB" strokeWidth="2" strokeLinecap="round" className="il-md-length-15 il-md-duration-4 il-md-delay-0"/>
                </g>
              </svg>
            </div>
          </div>
        ...
        <button className="logout_btn mt-auto" onClick={auth.logout} style={{position: 'absolute', bottom: '2rem'}}>
